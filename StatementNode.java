...
public abstract class StatementNode {
    ...
    /**
     *  Statement node representing a skip statement.
     */
    public static class SkipNode extends StatementNode {
        public SkipNode(Location loc) { super(loc); }

        @Override
        public void accept(StatementVisitor visitor) { visitor.visitSkipNode(this); }

        @Override
        public String toString(int level) { return "Skip"; }
    }

    /**
     *  Statement node representing a do statement.
     */
    public static class DoNode extends StatementNode {

        private final List<DoBranch> branches;

        public DoNode(Location loc, List<DoBranch> branches) {
            super(loc);
        ...
        public static class DoBranch {
            ...
            private StatementNode statementList;
            private boolean exit;

            public DoBranch (Location loc, ExpNode condition,
                             StatementNode statementList, boolean exit) {
                this.loc = loc;
            ...
            public StatementNode getStatementList() { return statementList; }
    ...
    public static class AssignmentNode extends StatementNode {
        ...
        public AssignmentNode(Location loc, List<ExpNode> variables, List<ExpNode> exps) {
            super(loc);
...
//        }
        ...
        @Override
        public String toString(int level) {
            return lValues.toString() + " := " + exps.toString();
        }
    }
