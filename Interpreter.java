...
public class Interpreter implements StatementVisitor, ExpTransform<Value> {
    ...
    public void visitAssignmentNode(StatementNode.AssignmentNode node) {
        ...
        List<ExpNode> lValues = node.getVariables();
        List<Value> expsEvaluated = new LinkedList<>();
        List<Value> lValsEvaluated = new LinkedList<>();
    ...
    public void visitDoNode(StatementNode.DoNode node) {
        ...
        List<StatementNode.DoNode.DoBranch> branches = node.getBranches();
